...
from scheduler.algorithms.scheduling.flowshop.ignition import ignite_program
...
from scheduler.algorithms.scheduling.flowshop import FlowShop
from scheduler.validators import valid_demand, valid_recipe, valid_program,\
    valid_pivot, valid_stop, valid_changeover  # BUG: incluir el valid_pivot en __init_demand
from scheduler.helpers.graphtools import create_network_template, create_orders_graph
from scheduler.helpers.metadata import raise_invalid_func, raise_invalid_scale,\
    raise_invalid_date
from scheduler.models import Program, Demand, Time, Recipe, FunctionType, Stop, \
    Changeover
# * Direct dependencies
