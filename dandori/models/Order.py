...
class Order(GraphQLType):
    ...
    demand: 'Demand' = attr.ib(default=None, repr=gql_repr, converter=convert_to(mpath,'Demand'), metadata={'type':GraphQLType,'model':'Demand'})
    solvedByPlans: List[GraphQLType] = attr.ib(factory=list, repr=gql_list_repr, converter=list_convert_to(mpath,'Plan'), metadata={'type':list,'model':'Plan'})
    requiredByPlans: List[GraphQLType] = attr.ib(factory=list, repr=gql_list_repr, converter=list_convert_to(mpath,'Plan'), metadata={'type':list,'model':'Plan'})
