...
def test_plan_start_after_order_start_routing(routing_result, guid, inputs):
    ...
    """
    program, _ = routing_result(guid, **inputs)
    assert program, \
...
@pytest.mark.routing
@pytest.mark.parametrize(["guid", "inputs"], cases.items())
def test_plan_end_before_order_end_routing(routing_result, guid, inputs):
    """Una orden tiene un intervalo de cumplimiento. Cada orden puede ser
    satisfecha por un conjunto de procesos de línea. La unión de estos
    intervalos de procesos de línea deben de completar el intervalo de la ordens.
    Args:
...
@pytest.mark.routing
@pytest.mark.parametrize(["guid", "inputs"], cases.items())
def test_plan_start_before_end_routing(routing_result, guid, inputs):
    """Una orden tiene un intervalo de cumplimiento. Cada orden puede ser
    satisfecha por un conjunto de procesos de línea. La unión de estos
    intervalos de procesos de línea deben de completar el intervalo de la ordens.
    Args:
...
@pytest.mark.routing
@pytest.mark.parametrize(["guid", "inputs"], cases.items())
def test_plan_no_overlaping_by_resource_routing(routing_result, guid, inputs):
    """Una orden tiene un intervalo de cumplimiento. Cada orden puede ser
    satisfecha por un conjunto de procesos de línea. La unión de estos
    intervalos de procesos de línea deben de completar el intervalo de la ordens.
    Args:
